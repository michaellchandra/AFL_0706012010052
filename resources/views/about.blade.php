...
@section('main_content')
    <div class="container p-5 mt-5 bg-primary bg-gradient text-light">
        ...
        <br>
        <p>Website ini dibuat menggunakan Framework PHP yaitu <b>Laravel</b> dan untuk penyimpanan Database menggunakan <b>MySQL</b> dengan bantuan phpMyAdmin dan MySQL WorkBench</p>
    </div>
@endsection